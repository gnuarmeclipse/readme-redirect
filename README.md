...
The initial [GNU ARM Eclipse](https://github.com/gnuarmeclipse) project was extended to include support for [RISC-V](https://riscv.org) devices, and since it is now multi-platform, it is rebranding as [GNU MCU Eclipse](https://github.com/gnu-mcu-eclipse).
